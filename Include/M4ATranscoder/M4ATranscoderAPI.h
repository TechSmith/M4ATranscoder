...
typedef int(*WAVETOM4AGETFORMATS_FUNC)(WaveToM4AHandle pHandle, std::vector<WAVEFORMATEX>** pReturn);
...
WAVETOM4A_EXTERN int WaveToM4AGetFormats(WaveToM4AHandle pHandle, std::vector<WAVEFORMATEX>** pReturn);
